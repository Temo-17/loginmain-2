...
fun Login(modifier: Modifier, viewModel: LoginViewModel) {
    ...
    val isLoading: Boolean by viewModel.loginEnable.observeAsState(initial = false)
...
fun HeaderImage(modifier: Modifier) {
    Image(painter = painterResource(id = R.drawable.ii), contentDescription = "Header", modifier=modifier)
}
